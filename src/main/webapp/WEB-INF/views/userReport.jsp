...
<body class="theme-red">
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
       ...
       <td><a class="btn btn-success"  style="margin:5px;" href="hello?id=<c:out value='${book.id}' />">Accept</a><a class="btn btn-danger" style="margin:5px;" href="hello?id=<c:out value='${book.id}' />">Reject</a></td>										</td>
