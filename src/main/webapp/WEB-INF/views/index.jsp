...
<meta charset="utf-8">
<link rel="shortcut icon" href="mobdog.png"
...
<link rel="stylesheet" type="text/css"
	href="carouselengine/initcarousel-1.css">
...
<body id="home">
	...
	<nav id="sidebar-wrapper"> <a id="menu-close" href="#"
		class="close-btn toggle"><i class="ion-ios-close-empty"></i></a>
		...
		<div class="headings">
			...
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-5">
					<div>
						<a
							href="https://play.google.com/store/apps/details?id=com.mobiledogabhinav.android&hl=en"
							class="polo-btn store wow animated bounceInUp"><i
				...
				<div class="col-xs-6 col-sm-6 col-md-5">
					<div>
						<a href="#" class="polo-btn store wow animated bounceInUp"
							data-toggle="popover"><i class="ion-social-apple"></i> App
							Store</a>
					</div>
				</div>
			</div>
	...
	<section id="features" class="block"> <section
		class="container"> <section class="row">
	<div class="title-box">
		<h1 class="block-title wow animated rollIn">
			<span class="bb-top-left"></span> <span class="bb-bottom-left"></span>
			Features <span class="bb-top-right"></span> <span
				class="bb-bottom-right"></span>
		</h1>
	</div>
	...
	<div class="title-box" style="color: #fff;">
		<h1 class="block-title wow animated rollIn">
			<span class="bb-top-left" style="border-color: #fff;"></span> <span
				class="bb-bottom-left" style="border-color: #fff;"></span> Gallery <span
				class="bb-top-right" style="border-color: #fff;"></span> <span
				class="bb-bottom-right" style="border-color: #fff;"></span>
		</h1>
	</div>
	</section> <section class="row">
	<div class="col-xs-12">
	...
	<section id="team" class="block"> <section class="container">
	<section class="row">
	<div class="col-md-12">
		<div class="title-box">
			<h1 class="block-title wow animated rollIn">
				<span class="bb-top-left"></span> <span class="bb-bottom-left"></span>
				Development Team <span class="bb-top-right"></span> <span
					class="bb-bottom-right"></span>
			</h1>
		</div>
	</div>
	</section> <section class="row"> <section class="col-md-3 col-sm-6">
	<div class="team-member wow animated fadeIn" data-wow-delay=="0.3s">
		<img src="images/1.jpg" class="img_res team-pic">
		<h2 class="wow animated fadeInDown" data-wow-delay=="0.7s">Full
			Stack Developer</h2>
	</div>
	</section> <section class="col-md-3 col-sm-6">
	<div class="team-member wow animated fadeIn" data-wow-delay=="0.3s">
	...
	<div class="team-member wow animated fadeIn" data-wow-delay=="0.3s">
		...
		<h2 class="wow animated fadeInDown" data-wow-delay=="0.7s">UI/UX
			developer</h2>
	</div>
	</section> <section class="col-md-3 col-sm-6">
	<div class="team-member wow animated fadeIn" data-wow-delay=="0.3s">
		<img src="images/vishu.jpg" class="img_res team-pic">
		<h2 class="wow animated fadeInDown" data-wow-delay=="0.7s">MEAN
			Stack Develper</h2>
	</div>
	...
	<div class="title-box">
		<h1 class="block-title wow animated rollIn">
			<span class="bb-top-left"></span> <span class="bb-bottom-left"></span>
			Precious APP Reviews <span class="bb-top-right"></span> <span
				class="bb-bottom-right"></span>
		</h1>
	</div>
	</section> </section> <section class="container"> <section class="row">
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="client-pic">
						<img class="img_res" src="images/vishu1.jpg">
					</div>
					<p class="review-star">
				...
				<div class="col-sm-6">
					<p class="review-desc">This is one of the great app that can
						make really funny and viral videos! Premium video editing features
						for free!!! Really Awesome.</p>
					<p class="client-name">Vishwanath Modi</p>
				</div>
			</div>
		</div>
		<div class="item">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="client-pic">
						<img class="img_res" src="images/nagesh.jpg">
					</div>
					<p class="review-star">
						<i class="ion-ios-star"></i> <i class="ion-ios-star"></i> <i
							class="ion-ios-star"></i> <i class="ion-ios-star"></i> <i
				...
				<div class="col-sm-6">
					<p class="review-desc">This is APp is most usefull parents and
						children, Emergency women safety,over all its cool adn awesome App
					</p>
					<p class="client-name">Nageswar Rao</p>
				</div>
			</div>
		</div>
		<div class="item">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="client-pic">
						<img class="img_res" src="assets/img/dev-1.jpg">
					</div>
					<p class="review-star">
						<i class="ion-ios-star"></i> <i class="ion-ios-star"></i> <i
							class="ion-ios-star"></i> <i class="ion-ios-star"></i> <i
				...
				<div class="col-sm-6">
					<p class="review-desc">Lorem ipsum dolor sit amet, consectetur
						adipisicing elit, sed do eiusmod tempor incididunt ut labore et
						dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
						exercitation ullamco laboris nisi ut aliquip ex ea commodo</p>
					<p class="client-name">Shahjahan Jewel</p>
				</div>
			</div>
		</div>
		<div class="item">
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="client-pic">
						<img class="img_res" src="assets/img/dev-2.jpg">
					</div>
					<p class="review-star">
						<i class="ion-ios-star"></i> <i class="ion-ios-star"></i> <i
							class="ion-ios-star"></i> <i class="ion-ios-star"></i> <i
	...
	<section id="contact"> <section
		class="container contact-wrap"> <section class="row">
	<div class="title-box">
		<h1 class="block-title wow animated rollIn">
			<span class="bb-top-left"></span> <span class="bb-bottom-left"></span>
			Contact Us <span class="bb-top-right"></span> <span
				class="bb-bottom-right"></span>
		</h1>
	</div>
	</section> </section> <section class="address">
	<div class="container">
		<div class="col-sm-12">
			<ul class="address-list">
				<li><i class="ion-ios-location"
					style="background-color: rgb(255, 102, 0);"></i> <span
					style="color: red;">#553 , 15th main 1st cross 3rd stage ,
						4th block , basaveswar nagar</span></li>
				<li><i class="ion-ios-telephone"
					style="background-color: #63cfea;"></i> <span style="color: red;">8880499463</span></li>
			</ul>
		</div>
	</div>
	</section> <section class="mailbox">
	<div class="container">
		<div class="col-sm-12">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<p class="help-block text-danger"></p>
							<div id="success"></div>
							<button type="submit" class="polo-btn contact-submit">
	...
	<div class="col-sm-6">
		...
		<h1 class="footer-logo">
			<a href="https://www.walkinsoftwares.com/">WalkinSoftware
				Technolgies PVT. LTD.</a>
		</h1>
	</div>
	<div class="col-sm-6">
