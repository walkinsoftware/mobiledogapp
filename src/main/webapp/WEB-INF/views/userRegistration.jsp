				...
				<td>
					<form action="userActivationProcess" method="post">
						<input id="userIds" name="userIds" type="hidden" 
							...
							name="operationType" type="hidden" /> <input type="text" style="width:50%;"
							name="reason" id="reason" /> <input type="submit" value="Accept" class="btn btn-success"
							id="accept" onclick="submitForm(this)" /> <input type="submit" class="btn btn-danger"
